...
| --- | --- | --- | --- |
| release truth model | implemented, tested locally, and remotely validated | `release/platform-status.json`; source `1853dd46ce1535dc01911308b53f2d14860337c2`; `evidence/security-platform/GITHUB_CI_1853dd4.json` | central Product 29 acceptance |
| artifact registry contract | tested locally | `release/artifact-registry.json`; `evidence/security-platform/LOCAL_ARTIFACT_DRILL_1853dd4.json`; reproducible source artifact `e32f5701d9e636e6555828bbfb36e23c0e93ad96c4706cde0f0a4d667c8ad689` | immutable hosting, installation evidence, and approved production signer |
...
| tracked sensitive-material gate | tested locally and in exact-source CI | `scripts/security-platform.mjs`; `evidence/security-platform/LOCAL_VERIFICATION_2026-07-22.md`; `evidence/security-platform/GITHUB_CI_1853dd4.json` | production inventory remains unconfigured |
