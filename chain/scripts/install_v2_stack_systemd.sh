...
Environment:
  ...
  BRIDGE_RELAYER_MODE default: remote
  BRIDGE_REMOTE_SIGNER_ADDRESS default: empty
  BRIDGE_ATTESTER_PRIVATE_KEY default: empty
  BRIDGE_RELAYER_PRIVATE_KEY default: empty
  BRIDGE_WATCHER_MAX_BLOCKS default: 2000
  BRIDGE_WATCHER_POLL_MS default: 0
  ...
  WEB4_REQUIRE_CHAIN_BINDING default: 0
  WEB4_CHAIN_STATUS_URL default: empty
  WEB4_CHAIN_STATUS_TIMEOUT_MS default: 3000
  WEB4_CHAIN_STATUS_CACHE_MS default: 2000
  ...
  YNX_PERSISTENT_PEERS default: empty (local node config)
  YNX_DESCRIPTOR_SEEDS default: YNX_SEEDS (public descriptor)
  YNX_DESCRIPTOR_PERSISTENT_PEERS default: YNX_PERSISTENT_PEERS (public descriptor)
...
FAUCET_KEY="${FAUCET_KEY:-validator}"
FAUCET_KEYRING="${FAUCET_KEYRING:-test}"
FAUCET_KEYRING_DIR="${FAUCET_KEYRING_DIR:-$YNX_HOME}"
FAUCET_GAS="${FAUCET_GAS:-250000}"
...
BRIDGE_RELAYER_MODE="${BRIDGE_RELAYER_MODE:-remote}"
BRIDGE_REMOTE_SIGNER_ADDRESS="${BRIDGE_REMOTE_SIGNER_ADDRESS:-}"
BRIDGE_ATTESTER_PRIVATE_KEY="${BRIDGE_ATTESTER_PRIVATE_KEY:-}"
BRIDGE_RELAYER_PRIVATE_KEY="${BRIDGE_RELAYER_PRIVATE_KEY:-}"
BRIDGE_WATCHER_MAX_BLOCKS="${BRIDGE_WATCHER_MAX_BLOCKS:-2000}"
BRIDGE_WATCHER_POLL_MS="${BRIDGE_WATCHER_POLL_MS:-0}"
...
WEB4_REQUIRE_CHAIN_BINDING="${WEB4_REQUIRE_CHAIN_BINDING:-0}"
WEB4_CHAIN_STATUS_URL="${WEB4_CHAIN_STATUS_URL:-}"
WEB4_CHAIN_STATUS_TIMEOUT_MS="${WEB4_CHAIN_STATUS_TIMEOUT_MS:-3000}"
WEB4_CHAIN_STATUS_CACHE_MS="${WEB4_CHAIN_STATUS_CACHE_MS:-2000}"
...
YNX_DESCRIPTOR_SEEDS="${YNX_DESCRIPTOR_SEEDS:-$YNX_SEEDS}"
YNX_DESCRIPTOR_PERSISTENT_PEERS="${YNX_DESCRIPTOR_PERSISTENT_PEERS:-$YNX_PERSISTENT_PEERS}"
...
BRIDGE_OPERATOR_TOKEN=$BRIDGE_OPERATOR_TOKEN
BRIDGE_RELAYER_MODE=$BRIDGE_RELAYER_MODE
BRIDGE_REMOTE_SIGNER_ADDRESS=$BRIDGE_REMOTE_SIGNER_ADDRESS
BRIDGE_ATTESTER_PRIVATE_KEY=$BRIDGE_ATTESTER_PRIVATE_KEY
BRIDGE_RELAYER_PRIVATE_KEY=$BRIDGE_RELAYER_PRIVATE_KEY
BRIDGE_WATCHER_MAX_BLOCKS=$BRIDGE_WATCHER_MAX_BLOCKS
BRIDGE_WATCHER_POLL_MS=$BRIDGE_WATCHER_POLL_MS
...
YNX_PERSISTENT_PEERS=$YNX_DESCRIPTOR_PERSISTENT_PEERS
...
Environment=FAUCET_KEY=$FAUCET_KEY
Environment=FAUCET_KEYRING=$FAUCET_KEYRING
Environment=FAUCET_GAS=$FAUCET_GAS
...
Environment=WEB4_REQUIRE_CHAIN_BINDING=$WEB4_REQUIRE_CHAIN_BINDING
Environment=WEB4_CHAIN_STATUS_URL=$WEB4_CHAIN_STATUS_URL
Environment=WEB4_CHAIN_STATUS_TIMEOUT_MS=$WEB4_CHAIN_STATUS_TIMEOUT_MS
Environment=WEB4_CHAIN_STATUS_CACHE_MS=$WEB4_CHAIN_STATUS_CACHE_MS
