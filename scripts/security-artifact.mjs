...
export const bundlePaths = [
  ...
  "release/artifact-registry.json",
  "release/completion-audit.json",
  "release/integration",
  "release/platform-status.json",
    ...
    predicate: {
      buildDefinition: {
        ...
        resolvedDependencies: [{
          uri: "git+https://github.com/JiahaoAlbus/YNX.git",
          digest: { gitCommit: sourceCommit },
        }],
      },
      runDetails: {
        builder: { id: "https://github.com/JiahaoAlbus/YNX/.github/workflows/security-platform-deploy.yml" },
        metadata: {
...
function buildMetadata(sourceCommit) {
  return {
    sourceCommit,
    sourceRepository: "https://github.com/JiahaoAlbus/YNX",
