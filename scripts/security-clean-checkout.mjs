...
function selectedReleaseArtifact(checkoutRoot) {
  const release = JSON.parse(readFileSync(resolve(checkoutRoot, "release/product-release.json"), "utf8"));
  const registry = JSON.parse(readFileSync(resolve(checkoutRoot, "release/artifact-registry.json"), "utf8"));
